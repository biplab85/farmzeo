...
export default function Hero() {
  ...
  return (
    <section ref={sectionRef} id="hero" className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-20 pb-12 sm:pt-24 sm:pb-16 md:pt-32 md:pb-20 lg:pt-40 lg:pb-32">
        <Container>
          <div className="flex flex-col items-center gap-8 sm:gap-12 lg:flex-row lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="mt-6">
                <SplitText
                  as="h1"
                  className="font-heading text-[28px] font-extrabold leading-[1.1] text-white sm:text-[36px] md:text-[52px] lg:text-[68px] lg:tracking-[-1.5px]"
                >
              ...
              <motion.div {...fadeUp(4)} className="mt-8 flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
                ...
                >
                  <span className="relative z-10 inline-flex items-center gap-2">
                    ...
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="transition-transform duration-300 group-hover:translate-x-0.5"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                  </span>
                  <div
