              ...
              <div className="mt-6 flex gap-3">
                {['facebook', 'twitter', 'instagram', 'linkedin'].map((platform) => (
                  <a
                    ...
                    href="#"
                    aria-label={platform}
                    className="group flex h-9 w-9 items-center justify-center rounded-lg bg-white/[0.06] text-gray-500 transition-all duration-300 hover:bg-secondary hover:text-white"
                  >
